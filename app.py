...
app=Flask(__name__)
model=pickle.load(open('C:\\Users\\PeterMakh\\Documents\\Documents\\School 2023 - DSC\\Advanced\\ML\\VSCode_SPM\\Diabetes_Flask_Example\\Diabetes_Flask_Example\\model\\Diabetes_Classifier.pkl','rb'))
